...
import {calenderItem, getAmenities, getPropertyType, priceInit,} from './SearchParams';
import {ButtonGroup, FilterArea, FilterElementsWrapper, ItemWrapper, RoomGuestWrapper,} from './MobileSearchView.style';
